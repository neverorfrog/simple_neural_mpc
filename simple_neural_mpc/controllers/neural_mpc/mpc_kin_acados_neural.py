...
class ModelPredictiveController(Controller):
    ...
    def _init_opti(self):
        ...
        # L4Casadi Stuff
        self.ocp.solver_options.model_external_shared_lib_dir = self.robot.l4casadi_model.shared_lib_dir
        self.ocp.solver_options.model_external_shared_lib_name = self.robot.l4casadi_model.name
