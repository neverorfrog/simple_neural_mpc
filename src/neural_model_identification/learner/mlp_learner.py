...
class Learner(AbstractLearner):
    ...
    def calc_loss(self, x):
        ...
        next_pair = [torch.hstack((states[:, 0, :], actions[:, 0, :]))] # [batch, state_dim + input_dim]
        ...
        generated_traj = torch.concatenate(next_states, dim=-1) # [batch, state_dim, horizon]
