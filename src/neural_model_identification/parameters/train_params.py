...
class TrainParams:
    ...
    data_path : str = f'{project_root()}/src/neural_model_identification/data/{models}' # path to the folder containing the data_file
    model_path : str = f'{project_root()}/src/neural_model_identification/trained_models/{models}/model.pth'
