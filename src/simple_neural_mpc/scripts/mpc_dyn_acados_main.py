from simple_neural_mpc.controllers.mpc.mpc_dyn_acados import (
    ModelPredictiveController as AcadosMPC,
)
from simple_neural_mpc.models.unicycle_dyn.unicycle_dyn_acados import Unicycle
...
if __name__ == "__main__":
    ...
    simulation = TrajectoryTrackingSimulation(
        "mpc_dyn_acados", robot, controller, reference
    )
