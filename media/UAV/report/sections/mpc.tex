...
Our work is based on a Crazyflie, which is a real quadrotor characterized by \dots 
\todo[inline]{infos about crazyflie}
This particular quadrotor has a particular firmware that takes as inputs roll, pitch and yaw desired positions instead of control torques. This happens since there is a low level attitude controller which performs this mapping for us. As a consequence, we have used a first order modified model for the MPC formulation.
...
\begin{align}
    ...
    \end{cases}  
\end{align}
\todo[inline]{double check + explanation}
