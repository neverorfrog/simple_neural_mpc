...
The kinematic model of the unicycle is a simplified representation of the movement of the vehicle
...
The kinematic model of a unicycle robot it is described by the following equations:
\begin{align}
    \label{eq:unicycle}
    \begin{cases}
...
Given the previous equations, if we assume aereodynamics and gyroscopic effects to be negligible and that we have small roll and pitch angles, we can derive the simplified model for the quadrotor:
\begin{align}
