...
main model. Our conjecture is that the pinn could constraint the network to have single basin, that is the global minima for the main model, while 
...
Future works are required for integrate the Neural-MPC framework into real world application. 

We hope that this project can offfer a comprehensive overview of the challenge and possibility for future step, as all the challenges encountered during the development 
